    ...
    fn toolContext(self: *AcpContext) tool_runtime.Context {
        ...
        var tc: tool_runtime.Context = .{
            ...
            .permission_reviewer_provider = switch (session.provider) {
                ...
                .openai => blk: {
                    const reviewer = self.state.cfg.openai_permission_reviewer_provider orelse break :blk null;
                    break :blk .{
                        .context = @ptrCast(@alignCast(@constCast(&self.state.openai_config))),
    ...
    return subagent_agent_adapter.run(.{
        ...
        .provider_routes = .{
            ...
            .openai = .{
                ...
                .permission_reviewer_provider = blk: {
                    const reviewer = state.cfg.openai_permission_reviewer_provider orelse break :blk null;
                    break :blk .{
